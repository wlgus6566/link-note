  ...
  const savedContent = [
    {
      ...
      source: "YouTube",
      date: "4월 10일",
      summary: "이 영상은 2025년 인공지능 기술의 발전 방향과 산업에 미치는 영향에 대해 분석합니다.",
      tags: ["AI", "기술", "미래", "트렌드"],
    ...
    },
    {
      ...
      source: "Instagram",
      date: "4월 8일",
      summary: "영양사가 추천하는 건강한 식습관을 위한 10가지 실천 가능한 팁을 소개합니다.",
      tags: ["건강", "식습관", "영양", "웰빙"],
      image: "/placeholder.svg?height=200&width=400",
    },
    {
      ...
      source: "Medium",
      date: "4월 5일",
      summary: "재택근무의 생산성을 높이기 위한 환경 구성과 습관에 대해 다룹니다.",
      tags: ["재택근무", "생산성", "업무환경"],
      image: "/placeholder.svg?height=200&width=400",
    },
    {
      ...
      source: "블로그",
      date: "4월 3일",
      summary: "다양한 색상이 소비자 행동과 브랜드 인식에 미치는 영향에 대해 설명합니다.",
      tags: ["마케팅", "심리학", "디자인"],
      image: "/placeholder.svg?height=200&width=400",
    },
    {
        ...
        <div className="container px-5 py-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
              ...
              {popularTags.map((tag) => (
                <Button key={tag} variant="outline" size="sm" className="text-xs whitespace-nowrap rounded-full">
                  {tag}
                </Button>
              ))}
            </div>
      ...
      <main className="flex-1">
        <div className="container px-5 py-4">
          <div className="flex items-center justify-between mb-4">
            <div className="text-sm text-gray-500">{savedContent.length}개 항목</div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {savedContent.map((content) => (
              <Link href={`/digest/${content.id}`} key={content.id} className="group">
                <div className="bg-white rounded-xl overflow-hidden shadow-sm transition-all duration-200 group-hover:shadow-md h-full flex flex-col">
                  ...
                  <div className="p-3 flex-1 flex flex-col">
                    <div className="text-xs text-gray-500 mb-1">{content.date}</div>
                    ...
                    <div className="flex flex-wrap gap-1 mt-auto">
                      {content.tags.slice(0, 2).map((tag) => (
                        <span key={tag} className="px-1.5 py-0.5 bg-gray-100 text-gray-700 rounded-full text-[10px]">
                          {tag}
                        </span>
                      ))}
